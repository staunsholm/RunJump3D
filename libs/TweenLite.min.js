...
(function (n)
{
    var G = function (a)
    {
        ...
        return c
    }, l = G("com.greensock"), p, j, d, B, H, w = {}, C = function (a, c, b, i)
    {
        this.sc = w[a] ? w[a].sc : [];
        w[a] = this;
        this.gsClass = null;
        ...
        {
            for (var f = e.length, g = 0, m; -1 < --f;)(m = w[e[f]] || new C(e[f])).gsClass ? d[f] = m.gsClass : (g++, c && m.sc.push(this));
            if (0 === g && b)
            {
                var c = ("com.greensock." + a).split("."), f = c.pop(), j = G(c.join("."))[f] = this.gsClass = b.apply(b, d);
                i && ((n.GreenSockGlobals ||
                    n)[f] = j, "function" === typeof define && define.amd ? define((n.GreenSockAMDPath ? n.GreenSockAMDPath + "/" : "") + a.split(".").join("/"), [], function ()
                {
                    return j
    ...
    n._gsDefine = function (a, c, b, i)
    {
        return new C(a, c, b, i)
    };
    var I = [0, 0, 1, 1], D = [], t = r("easing.Ease", function (a, c, b, i)
    {
        this._func = a;
        this._type = b || 0;
        this._power =
    ...
    d.getRatio = function (a)
    {
        ...
        var c = this._type, b = this._power, i = 1 === c ? 1 - a : 2 === c ? a : 0.5 > a ? 2 * a : 2 * (1 - a);
        1 === b ? i *= i : 2 === b ? i *= i * i : 3 === b ? i *= i * i * i : 4 === b && (i *= i * i * i * i);
        return 1 === c ? 1 - i : 2 === c ? i : 0.5 > a ? i / 2 : 1 - i / 2
    };
    p = ["Linear", "Quad", "Cubic", "Quart", "Quint"];
    for (j = p.length; -1 < --j;)
    {
        d = r("easing." + p[j], function ()
        {
        }, !0), B = r("easing.Power" + j, function ()
        {
        }, !0), d.easeOut = B.easeOut = new t(null,
    ...
    d = J.prototype;
    d.addEventListener = function (a, c, b, i, e)
    {
        ...
        d.splice(h, 0, {c: c, s: b, up: i, pr: e})
    };
    ...
    d.dispatchEvent = function (a)
    {
        ...
        if (c)for (var b = c.length, i, d = this._eventTarget; -1 < --b;)i = c[b], i.up ? i.c.call(i.s || d, {type: a, target: d}) : i.c.call(i.s || d)
    };
    var y = n.requestAnimationFrame, E = n.cancelAnimationFrame, K = Date.now || function ()
    {
        return(new Date).getTime()
    };
    p = ["ms", "moz", "webkit", "o"];
    for (j = p.length; -1 < --j && !y;)
    {
        y = n[p[j] + "RequestAnimationFrame"], E = n[p[j] +
            "CancelAnimationFrame"] || n[p[j] + "CancelRequestAnimationFrame"];
    }
    r("Ticker", function (a, c)
    {
        var b = this, i = K(), d = !1 !== c && y, k, h, f, g, m, j = function ()
        {
            null != f && (!d || !E ? n.clearTimeout(f) : E(f), f = null)
        }, l = function (a)
        {
            b.time = (K() - i) / 1E3;
            if (!k || b.time >= m || a)b.frame++, m = b.time > m ? b.time + g - (b.time - m) : b.time + g - 0.001, m < b.time + 0.001 && (m = b.time + 0.001), b.dispatchEvent("tick");
            !0 !== a && (f = h(l))
        };
        J.call(b);
        ...
        this.fps = function (a)
        {
            ...
            {
                return n.setTimeout(a, 1E3 * (m - b.time) + 1 >> 0 || 1)
            } : y;
            j();
            f = h(l)
        };
    ...
    d.eventCallback = function (a, c, b, i)
    {
            ...
            2))
        {
            ...
            else if (this.vars[a] = c, this.vars[a + "Params"] = b, this.vars[a + "Scope"] = i, b)for (var d = b.length; -1 < --d;)"{self}" === b[d] && (b = this.vars[a + "Params"] = b.concat(), b[d] = this);
    ...
    d.totalTime = function (a, c)
    {
        ...
        if (this._timeline)
        {
            ...
            this._totalTime != a && this.render(a,
                c, !1)
        }
        return this
    };
    ...
    d.paused = function (a)
    {
        ...
        a != this._paused && this._timeline && (!a && this._timeline.smoothChildTiming && (this._startTime += this._timeline.rawTime() - this._pauseTime, this._uncache(!1)), this._pauseTime = a ? this._timeline.rawTime() : null, this._paused = a, this._active = !this._paused && 0 < this._totalTime &&
    ...
    {
        a.timeline === this && (c || a._enabled(!1, !0), a.timeline = null, a._prev ? a._prev._next = a._next : this._first === a && (this._first = a._next), a._next ? a._next._prev = a._prev : this._last === a && (this._last = a._prev), this._timeline &&
            this._uncache(!0));
        return this
    };
    ...
    var g = r("TweenLite", function (a, c, b)
    {
        q.call(this, c, b);
        if (null == a)throw"Cannot tween an undefined reference.";
        this.target =
            a;
        this._overwrite = null == this.vars.overwrite ? L[g.defaultOverwrite] : "number" === typeof this.vars.overwrite ? this.vars.overwrite >> 0 : L[this.vars.overwrite];
        if ((a instanceof Array || a.jquery) && "object" === typeof a[0])
        {
            ...
            {
                b = this._targets[a], b.jquery ? (this._targets.splice(a--, 1), this._targets = this._targets.concat(b.constructor.makeArray(b))) : (this._siblings[a] = z(b, this, !1), 1 === this._overwrite && 1 < this._siblings[a].length &&
                    F(b, this, null, 1, this._siblings[a]))
            }
        }
        else
        {
            this._propLookup = {}, this._siblings = z(a, this, !1), 1 === this._overwrite && 1 < this._siblings.length && F(a, this, null, 1, this._siblings);
        }
    ...
    g.version = 12;
    g.defaultEase = d._ease = new t(null, null, 1, 1);
    g.defaultOverwrite =
        "auto";
    g.ticker = s;
    var M = g._plugins = {}, v = g._tweenLookup = {}, O = 0, P = {ease: 1, delay: 1, overwrite: 1, onComplete: 1, onCompleteParams: 1, onCompleteScope: 1, useFrames: 1, runBackwards: 1, startAt: 1, onUpdate: 1, onUpdateParams: 1, onUpdateScope: 1, onStart: 1, onStartParams: 1, onStartScope: 1, onReverseComplete: 1, onReverseCompleteParams: 1, onReverseCompleteScope: 1, onRepeat: 1, onRepeatParams: 1, onRepeatScope: 1, easeParams: 1, yoyo: 1, orientToBezier: 1, immediateRender: 1, repeat: 1, repeatDelay: 1, data: 1, paused: 1, reversed: 1}, L = {none: 0, all: 1,
        auto: 2, concurrent: 3, allOnStart: 4, preexisting: 5, "true": 1, "false": 0}, x = q._rootFramesTimeline = new l, u = q._rootTimeline = new l;
    u._startTime = s.time;
    ...
    }, F = function (a, c, b, d, e)
    {
        ...
        var g = c._startTime + 1E-10, m = [], j = 0, l;
        for (k = e.length; -1 < --k;)
        {
            if (!((f = e[k]) === c || f._gc || f._paused))
            {
                f._timeline !== c._timeline ? (l = l || N(c, 0), 0 === N(f, l) && (m[j++] = f)) : f._startTime <=
                    g && f._startTime + f.totalDuration() / f._timeScale + 1E-10 > g && ((0 === c._duration || !f._initted) && 2E-10 >= g - f._startTime || (m[j++] = f));
            }
        }
        for (k = j; -1 < --k;)if (f = m[k], 2 === d && f._kill(b, a) && (h = !0), 2 !== d || !f._firstPT && f._initted)f._enabled(!1, !1) && (h = !0);
        return h
    }, N = function (a, c)
    {
    ...
    d._init =
        function ()
        {
            ...
            var a, c;
            this._ease = this.vars.ease instanceof t ? this.vars.easeParams instanceof Array ? this.vars.ease.config.apply(this.vars.ease, this.vars.easeParams) : this.vars.ease : "function" === typeof this.vars.ease ? new t(this.vars.ease, this.vars.easeParams) : g.defaultEase;
    ...
    d._initProps = function (a, c, b, d)
    {
        ...
        for (e in this.vars)
        {
            if (P[e])
            {
                if ("onStartParams" === e || "onUpdateParams" === e || "onCompleteParams" === e || "onReverseCompleteParams" === e || "onRepeatParams" === e)if (g = this.vars[e])for (k = g.length; -1 < --k;)"{self}" === g[k] && (g = this.vars[e] = g.concat(), g[k] = this)
            }
            else if (M[e] && (f = new M[e])._onInitTween(a, this.vars[e], this))
            {
                ...
                for (k = f._overwriteProps.length; -1 < --k;)c[f._overwriteProps[k]] = this._firstPT;
                if (f._priority || f._onInitAllProps)h = !0;
                if (f._onDisable || f._onEnable)this._notifyPluginsOfEnabled = !0
            }
            else
            {
                this._firstPT = c[e] = j = {_next: this._firstPT, t: a, p: e, f: "function" === typeof a[e], n: e, pg: !1, pr: 0}, j.s = !j.f ? parseFloat(a[e]) : a[e.indexOf("set") || "function" !== typeof a["get" + e.substr(3)] ? e : "get" + e.substr(3)](), k = this.vars[e], j.c = "number" === typeof k ? k - j.s : "string" === typeof k && "=" === k.charAt(1) ? parseInt(k.charAt(0) + "1") * Number(k.substr(2)) : Number(k) || 0;
            }
            j && j._next &&
            (j._next._prev = j)
        }
        return d && this._kill(d, a) ? this._initProps(a, c, b, d) : 1 < this._overwrite && this._firstPT && 1 < b.length && F(a, this, c, this._overwrite, b) ? (this._kill(c, a), this._initProps(a, c, b, d)) : h
    };
    d.render = function (a, c, b)
    {
        var d = this._time, e, k;
        if (a >= this._duration)
        {
            if (this._totalTime = this._time = this._duration, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (e = !0, k = "onComplete"), 0 === this._duration)
            {
            ...
            a)
        {
            ...
            if (0 !== d || 0 === this._duration && 0 < this._rawPrevTime)k = "onReverseComplete", e = this._reversed;
        ...
        else if (this._totalTime = this._time = a, this._easeType)
        {
            ...
            3 === f && (h *= 2);
            1 === g ? h *= h : 2 === g ? h *= h * h : 3 === g ? h *= h * h * h : 4 === g && (h *= h * h *
                h * h);
        ...
        if (this._time !== d || b)
        {
            ...
            k && !this._gc && (e && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), c || this.vars[k] && this.vars[k].apply(this.vars[k + "Scope"] || this, this.vars[k + "Params"] || D))
        }
    };
    d._kill = function (a, c)
    {
        ...
        var c = c || this._targets || this.target, b, d, e, g, h, f, j;
        if ((c instanceof
            Array || c.jquery) && "object" === typeof c[0])
        {
        ...
        else
        {
            ...
            if (g)
            {
                for (e in f = a || g, j = a != d && "all" != d && a != g && (null == a || !0 != a._tempKill),
                    f)
                {
                    if (b = g[e])
                    {
    ...
    g.getTweensOf = function (a)
    {
        if (null != a)
        {
            var c, b, d;
            if ((a instanceof
                Array || a.jquery) && "object" === typeof a[0])
            {
                c = a.length;
    ...
    d._addTween = function (a, c, b, d, e, g)
    {
        var h;
        if (null !=
            d && (h = "number" === typeof d || "=" !== d.charAt(1) ? Number(d) - b : parseInt(d.charAt(0) + "1") * Number(d.substr(2))))
        {
    ...
    d._kill = function (a)
    {
        ...
        else
        {
            ...
            {
                null != a[this._overwriteProps[c]] &&
                this._overwriteProps.splice(c, 1);
            }
        }
    ...
    g._onPluginEvent = function (a, c)
    {
        ...
        if ("_onInitAllProps" === a)
        {
            for (var e, g, h, f; b;)
            {
                ...
                (b._prev =
                    e ? e._prev : h) ? b._prev._next = b : g = b;
    ...
    {
        for (var c = a.length; -1 < --c;)a[c].API === A.API && (g._plugins[(new a[c])._propName] = a[c]);
        return!0
    };
    if (p = n._gsQueue)
    {
