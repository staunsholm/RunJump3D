            ...
            else if (h instanceof a.Mesh)
            {
                ...
                for (var G = 0, P = o.faces.length; G < P; G++)
                {
                    ...
                    if (void 0 !== l && (l = l.side, e.sub(B.centroid, c), u = B.normal, v = d.dot(u), !(Math.abs(v) < C) && (u = u.dot(e) / v, !(0 >
                        u) && (l === a.DoubleSide || (l === a.FrontSide ? 0 > v : 0 < v)))))
                    {
                        if (f.add(c, d.multiplyScalar(u)), B instanceof a.Face3)
                        {
                            l = p[B.a], v = p[B.b], u = p[B.c], n(f, l, v, u) && (v = h.matrixWorld.multiplyVector3(f.clone()), l = b.distanceTo(v), l < i.near || l > i.far || j.push({distance: l, point: v, face: B, faceIndex: G, object: h}));
                        }
                        else if (B instanceof a.Face4 && (l = p[B.a], v = p[B.b], u = p[B.c], D = p[B.d], n(f, l, v, D) || n(f, v, u, D)))v = h.matrixWorld.multiplyVector3(f.clone()), l = b.distanceTo(v), l < i.near || l > i.far || j.push({distance: l, point: v, face: B, faceIndex: G, object: h})
                    }
                }
            }
        },
...
THREE.Projector = function ()
{
    ...
    this.projectScene = function (g, h, m, Q)
    {
            ...
            for (var c = 0, d = b.children.length; c < d; c++)
            {
                ...
                if (!1 !== f.visible)
                {
                    ...
                    else if (f instanceof THREE.Mesh || f instanceof THREE.Line)
                    {
                        ...
                        {
                            e = a(), e.object = f, null !== f.renderDepth ?
            ...
            m; g++)if (Aa = G.objects[g].object, Na = Aa.matrixWorld, j = 0, Aa instanceof THREE.Mesh)
        {
            ...
            {
                i = b(), i.positionWorld.copy(ca[X]), Na.multiplyVector3(i.positionWorld), i.positionScreen.copy(i.positionWorld), K.multiplyVector4(i.positionScreen), i.positionScreen.x /= i.positionScreen.w, i.positionScreen.y /= i.positionScreen.w,
                    i.visible = i.positionScreen.z > Z && i.positionScreen.z < L;
            }
            ca = 0;
            for (X = ma.length; ca < X; ca++)
            {
                if (fa = ma[ca], ib = !0 === Ea ? rb.materials[fa.materialIndex] : Aa.material, void 0 !== ib)
                {
                    aa = ib.side;
                    if (fa instanceof THREE.Face3)
                    {
                        if (Y = l[fa.a], ba = l[fa.b], ia = l[fa.c], !0 === Y.visible && !0 === ba.visible && !0 === ia.visible)
                        {
                            if (oa = 0 > (ia.positionScreen.x - Y.positionScreen.x) * (ba.positionScreen.y - Y.positionScreen.y) - (ia.positionScreen.y - Y.positionScreen.y) * (ba.positionScreen.x - Y.positionScreen.x), aa === THREE.DoubleSide || oa === (aa === THREE.FrontSide))
                            {
                                p ===
                                    s ? (sa = new THREE.RenderableFace3, o.push(sa), s++, p++, n = sa) : n = o[p++], n.v1.copy(Y), n.v2.copy(ba), n.v3.copy(ia);
                            }
                            else
                            {
                                continue;
                    ...
                    {
                        if (Y = l[fa.a], ba = l[fa.b], ia = l[fa.c], sa = l[fa.d], !0 === Y.visible && !0 === ba.visible && !0 === ia.visible && !0 === sa.visible)
                        {
                            if (oa = 0 > (sa.positionScreen.x - Y.positionScreen.x) * (ba.positionScreen.y - Y.positionScreen.y) - (sa.positionScreen.y - Y.positionScreen.y) * (ba.positionScreen.x - Y.positionScreen.x) || 0 > (ba.positionScreen.x - ia.positionScreen.x) * (sa.positionScreen.y -
...
THREE.SceneLoader.prototype.parse = function (a, b, c)
{
    ...
    R = N;
    for (n in Q.geometries)if (t = Q.geometries[n], "cube" === t.type)D = new THREE.CubeGeometry(t.width, t.height, t.depth, t.widthSegments, t.heightSegments, t.depthSegments), M.geometries[n] = D;
    else if ("plane" === t.type)D = new THREE.PlaneGeometry(t.width, t.height, t.widthSegments, t.heightSegments), M.geometries[n] = D;
    else if ("sphere" === t.type)D = new THREE.SphereGeometry(t.radius, t.widthSegments,
        t.heightSegments), M.geometries[n] = D;
    else if ("cylinder" === t.type)D = new THREE.CylinderGeometry(t.topRad, t.botRad, t.height, t.radSegs, t.heightSegs), M.geometries[n] = D;
    else if ("torus" === t.type)D = new THREE.TorusGeometry(t.radius, t.tube, t.segmentsR, t.segmentsT), M.geometries[n] = D;
    else if ("icosahedron" === t.type)D = new THREE.IcosahedronGeometry(t.radius, t.subdivisions), M.geometries[n] = D;
...
THREE.WebGLRenderer = function (a)
{
    ...
    function i(a, b, c)
    {
        ...
        if (c.sortParticles)
        {
            ...
            if (s)
            {
                ...
                for (j = s.length; i < j; i++)if (h = s[i], void 0 === h.boundTo || "vertices" === h.boundTo)if (f = 0, e = h.value.length, 1 === h.size)for (d =
                                                                                                                                                                  0; d < e; d++)g = m[d][1], h.array[d] = h.value[g];
        ...
        else
        {
            ...
            {
                i = 0;
                for (j = s.length; i < j; i++)if (h = s[i], h.needsUpdate && (void 0 === h.boundTo || "vertices" === h.boundTo))if (e = h.value.length, f = 0, 1 === h.size)for (d = 0; d < e; d++)h.array[d] = h.value[d];
                              ...
                              0; d < e; d++)g = h.value[d], h.array[f] = g.x, h.array[f + 1] = g.y, h.array[f + 2] = g.z, f += 3;
    ...
    function q(a, b, c, d, e)
    {
        ...
        if (f)
        {
            ...
            b = d.uniformsList;
            i = 0;
            for (T = b.length; i < T; i++)if (f = g.uniforms[b[i][1]])if (c = b[i][0], l = c.type, j = c.value, "i" === l)k.uniform1i(f, j);
            ...
            else if ("c" === l)k.uniform3f(f, j.r, j.g,
                j.b);
    ...
    this.render = function (a, b, c, d)
    {
        ...
        else
        {
            ...
            for (e = h.length; d < e; d++)if (f = h[d], g = f.object, f.render = !1, g.visible && (!(g instanceof THREE.Mesh || g instanceof THREE.ParticleSystem) || !g.frustumCulled || va.contains(g)))
            {
                ...
                if (q instanceof THREE.MeshFaceMaterial)r = s.materialIndex, 0 <= r && (r = q.materials[r], r.transparent ? (m.transparent = r, m.opaque = null) : (m.opaque = r, m.transparent = null));
                else if (r = q)r.transparent ? (m.transparent = r, m.opaque = null) : (m.opaque = r, m.transparent = null);
                f.render = !0;
    ...
    this.initWebGLObjects = function (a)
    {
        ...
        for (; a.__objectsAdded.length;)
        {
            ...
            if (!b.__webglActive)
            {
                if (b instanceof THREE.Mesh)if (m = b.geometry, m instanceof THREE.BufferGeometry)s(l.__webglObjects, m, b);
                else for (n in m.geometryGroups)p = m.geometryGroups[n], s(l.__webglObjects, p, b);
                else b instanceof THREE.Ribbon || b instanceof THREE.Line || b instanceof THREE.ParticleSystem ? (m = b.geometry, s(l.__webglObjects, m, b)) : b instanceof THREE.ImmediateRenderObject ||
        ...
        for (var Na = 0, xa = a.__webglObjects.length; Na < xa; Na++)
        {
            ...
            if (qa instanceof THREE.Mesh)if (T instanceof THREE.BufferGeometry)(T.verticesNeedUpdate || T.elementsNeedUpdate || T.uvsNeedUpdate || T.normalsNeedUpdate || T.colorsNeedUpdate ||
                T.tangentsNeedUpdate) && j(T, k.DYNAMIC_DRAW, !T.dynamic), T.verticesNeedUpdate = !1, T.elementsNeedUpdate = !1, T.uvsNeedUpdate = !1, T.normalsNeedUpdate = !1, T.colorsNeedUpdate = !1, T.tangentsNeedUpdate = !1;
            else
            {
                    ...
                    if (ra.__inittedArrays)
                    {
                        ...
                        if (Pc && mb)
                        {
                            ...
                            for ($ = ta.length; F < $; F++)if (S = $a[ta[F]], eb = S.vertexNormals, bb = S.normal, 3 === eb.length && lb)for (wa = 0; 3 > wa; wa++)ac = eb[wa], wb[Za] = ac.x, wb[Za + 1] =
                                ac.y, wb[Za + 2] = ac.z, Za += 3;
                            else for (wa = 0; 3 > wa; wa++)wb[Za] = bb.x, wb[Za + 1] = bb.y, wb[Za + 2] = bb.z, Za += 3;
                            F = 0;
                            for ($ = ua.length; F < $; F++)if (S = $a[ua[F]], eb = S.vertexNormals, bb = S.normal, 4 === eb.length && lb)for (wa = 0; 4 > wa; wa++)ac = eb[wa], wb[Za] = ac.x, wb[Za + 1] = ac.y, wb[Za + 2] = ac.z, Za += 3;
                            else for (wa = 0; 4 > wa; wa++)wb[Za] = bb.x, wb[Za + 1] = bb.y, wb[Za + 2] = bb.z, Za += 3;
                    ...
                    va)
                {
                    ...
                    if (Xc)
                    {
                            ...
                            Ca.boundTo))
                        {
                            za = 0;
                            mc = Ca.value.length;
                            if (1 === Ca.size)for (Xa = 0; Xa < mc; Xa++)Ca.array[Xa] = Ca.value[Xa];
                            else if (2 === Ca.size)for (Xa = 0; Xa < mc; Xa++)gb = Ca.value[Xa], Ca.array[za] = gb.x, Ca.array[za + 1] = gb.y, za += 2;
                            else if (3 === Ca.size)if ("c" === Ca.type)for (Xa = 0; Xa < mc; Xa++)gb = Ca.value[Xa], Ca.array[za] = gb.r, Ca.array[za + 1] = gb.g, Ca.array[za + 2] = gb.b, za += 3;
                            else for (Xa = 0; Xa < mc; Xa++)gb = Ca.value[Xa], Ca.array[za] = gb.x, Ca.array[za + 1] = gb.y, Ca.array[za + 2] = gb.z, za += 3;
                            else if (4 === Ca.size)for (Xa = 0; Xa < mc; Xa++)gb = Ca.value[Xa], Ca.array[za] =
                ...
                if (T.verticesNeedUpdate || T.colorsNeedUpdate || T.lineDistancesNeedUpdate || va)
                {
                    ...
                    if (Yc)
                    {
                        ...
                        for (gd = Yc.length; Oc < gd; Oc++)if (Da = Yc[Oc], Da.needsUpdate && (void 0 === Da.boundTo || "vertices" === Da.boundTo))
                        {
                            Ia = 0;
                            nc = Da.value.length;
                            if (1 === Da.size)for (Ya = 0; Ya < nc; Ya++)Da.array[Ya] = Da.value[Ya];
                            else if (2 === Da.size)for (Ya = 0; Ya < nc; Ya++)hb =
                                Da.value[Ya], Da.array[Ia] = hb.x, Da.array[Ia + 1] = hb.y, Ia += 2;
                            else if (3 === Da.size)if ("c" === Da.type)for (Ya = 0; Ya < nc; Ya++)hb = Da.value[Ya], Da.array[Ia] = hb.r, Da.array[Ia + 1] = hb.g, Da.array[Ia + 2] = hb.b, Ia += 3;
                            else for (Ya = 0; Ya < nc; Ya++)hb = Da.value[Ya], Da.array[Ia] = hb.x, Da.array[Ia + 1] = hb.y, Da.array[Ia + 2] = hb.z, Ia += 3;
                            else if (4 === Da.size)for (Ya = 0; Ya < nc; Ya++)hb = Da.value[Ya], Da.array[Ia] = hb.x, Da.array[Ia + 1] = hb.y, Da.array[Ia + 2] = hb.z, Da.array[Ia + 3] = hb.w, Ia += 4;
        ...
        function (a, b)
        {
            if (a.needsUpdate)
            {
                ...
                if (a instanceof THREE.CompressedTexture)for (var f = a.mipmaps, g = 0, h = f.length; g <
                    h; g++)c = f[g], k.compressedTexImage2D(k.TEXTURE_2D, g, e, c.width, c.height, 0, c.data);
...
THREE.CubeGeometry = function (a, b, c, d, e, f)
{
    function g(a, b, c, d, e, f, g, s)
    {
        ...
        else if ("x" === a && "z" === b || "z" === a && "x" === b)t = "y", z = h.depthSegments;
        else if ("z" === a && "y" === b || "y" === a && "z" === b)t = "x", r = h.depthSegments;
        ...
        for (p = E.length; n < p; n++)
        {
            ...
            if (!o.shadowCamera)
            {
                if (o instanceof THREE.SpotLight)o.shadowCamera =
                    new THREE.PerspectiveCamera(o.shadowCameraFov, o.shadowMapWidth / o.shadowMapHeight, o.shadowCameraNear, o.shadowCameraFar);
